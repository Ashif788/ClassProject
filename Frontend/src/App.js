    ...
    <div className="App" style={{ height: '100%', overflow: 'auto' }}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/Registration/:RIId" element={<Registration></Registration>}></Route>
          <Route path="/instituteregistration" element={<InstituteRegistration></InstituteRegistration>}></Route>
          <Route path="/:RIId/createpassword" element={<CreatePassword></CreatePassword>}></Route>
